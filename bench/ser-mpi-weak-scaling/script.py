...
def printfun(rank, blocklist,itercount):
  for s in blocklist:
      for mode in ["forward","gradient"]:
        os.system("mpirun -n {} taskset -c 0-{} numactl -i all ~/CODI-LULESH/lulesh-{}/lulesh2.0 -s {} -i {} > ser-mpi_{}_{}_{}_{}.txt".format(rank,rank-1,mode,s,itercount,mode,rank,itercount,s))
